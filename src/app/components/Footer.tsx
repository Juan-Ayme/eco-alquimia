      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-bold text-xl">Conservación Ambiental</span>
            </div>
            <p className="text-gray-400 mb-6">
              Trabajando juntos por un futuro más verde y sostenible para las generaciones venideras.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="/donacion" className="text-gray-400 hover:text-green-500 transition-colors">
                  Donar
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 text-gray-400">
                ...
                <span>juanayme565@gmail.com</span>
              </li>
              <li className="flex items-center gap-3 text-gray-400">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="font-bold text-lg mb-6">Boletín Informativo</h3>
            <p className="text-gray-400 mb-6">
              Suscríbete para recibir noticias y actualizaciones sobre nuestros proyectos.
            </p>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} EcoAlquimia. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
